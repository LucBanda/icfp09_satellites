...
lstatus = (memory[5] ==  0);
if (lstatus) memory[130]= memory[128]; else memory[130] = memory[103];
...
lstatus = (memory[5] ==  0);
if (lstatus) memory[153]= memory[151]; else memory[153] = memory[133];
...
lstatus = (memory[5] ==  0);
if (lstatus) memory[184]= memory[182]; else memory[184] = memory[166];
...
lstatus = (memory[5] ==  0);
if (lstatus) memory[204]= memory[202]; else memory[204] = memory[192];
...
lstatus = (memory[5] ==  0);
if (lstatus) memory[232]= memory[230]; else memory[232] = memory[213];
...
lstatus = (memory[245] ==  0);
if (lstatus) memory[247]= memory[240]; else memory[247] = memory[3];
memory[248] = memory[239] - memory[17];
lstatus = (memory[248] <  0);
...
lstatus = (memory[5] ==  0);
if (lstatus) memory[281]= memory[279]; else memory[281] = memory[270];
...
lstatus = (memory[5] ==  0);
if (lstatus) memory[321]= memory[319]; else memory[321] = memory[303];
memory[322] = memory[384];
lstatus = (memory[5] ==  0);
if (lstatus) memory[324]= memory[3]; else memory[324] = memory[322];
memory[325] = memory[383];
lstatus = (memory[5] ==  0);
if (lstatus) memory[327]= memory[3]; else memory[327] = memory[325];
...
lstatus = (memory[245] ==  0);
if (lstatus) memory[334]= memory[332]; else memory[334] = memory[3];
lstatus = (memory[248] <  0);
...
lstatus = (memory[352] <  0);
if (lstatus) memory[354]= memory[349]; else memory[354] = memory[3];
memory[355] = memory[342] - memory[3];
memory[356] = memory[372] - memory[0];
lstatus = (memory[355] <  0);
if (lstatus) memory[358]= memory[356]; else memory[358] = memory[354];
memory[359] = memory[338] - memory[341];
lstatus = (memory[359] <  0);
if (lstatus) memory[361]= memory[356]; else memory[361] = memory[358];
...
if (lstatus) memory[371]= memory[356]; else memory[371] = memory[361];
